...
FDA_MAIN_ITEMS = [
    {
        ...
        "text_en": "Change made with intent to significantly improve the safety or effectiveness of the device",
    },
    {"key": "MAIN2", "text": "라벨링(Labeling) 변경입니까?", "text_en": "Labeling change?"},
    {
        "key": "MAIN3", "text": "기술/엔지니어링/성능(Technology, Engineering, or Performance) 변경입니까?",
        "text_en": "Technology, engineering, or performance change?",
    },
    {"key": "MAIN4", "text": "재료(Materials) 변경입니까?", "text_en": "Materials change?"},
]
...
FDA_GRAPH = {
    ...
    "A1": {
        "text": "사용목적(Indications for Use) 문구에 변경이 있습니까?",
        "text_en": "Is it a change in the indications for use statement?",
        "yes": "A1.1", "no": "A2",
    },
    "A2": {
        "text": "금기사항(Contraindication)을 추가하거나 삭제합니까?",
        "text_en": "Does the change add or delete a contraindication?",
        "yes": "NEW_510K", "no": "A3",
    },
    "A3": {
        "text": "경고(Warning) 또는 주의사항(Precaution)에 변경이 있습니까?",
        "text_en": "Is it a change in the warnings or precautions?",
        "yes": "A1.1", "no": "A4",
    },
    "A4": {
        "text": "사용설명서(Directions for Use)에 영향을 줄 수 있는 변경입니까?",
        "text_en": "Could it affect the directions for use?",
        "yes": "A1.1", "no": "DOCUMENTATION",
    },
    "A1.1": {
        "text": "단회용(single use only) 라벨을 재사용(reusable) 라벨로 변경합니까?",
        "text_en": "Is it a change from a device labeled for single use only to a device labeled as reusable?",
        "yes": "NEW_510K", "no": "A1.2",
    },
    "A1.2": {
        "text": "처방(Rx) 전용에서 일반의약품(OTC) 사용으로 변경합니까?",
        "text_en": "Is it a change from prescription (Rx) to over the counter (OTC) use?",
        "yes": "NEW_510K", "no": "A1.3",
    },
    "A1.3": {
        "text": "기기명 변경이거나, 가독성/명확성 개선만을 위한 변경입니까?",
        "text_en": "Is it a change to the device name or a change solely to improve readability or clarity?",
        "yes": "DOCUMENTATION", "no": "A1.4",
    },
    "A1.4": {
        "text": "진단·치료·예방·완화 대상이 되는 새로운 질병, 상태, 또는 환자군을 기술합니까?",
        "text_en": "Does the change describe a new disease, condition, or patient population that the device "
    ...
    "A1.5": {
        ...
        "text_en": "Does a risk-based assessment of the changed device identify any new risks or significantly "
    ...
    "B1": {
        "text": "이 기기는 체외진단기기(IVD, In Vitro Diagnostic Device)입니까?",
        "text_en": "Is the device an in vitro diagnostic device?",
        "yes": "MANUAL_REVIEW_IVD", "no": "B2",
    },
    "B2": {
        "text": "제어기전(control mechanism), 작동원리(operating principle), 또는 에너지 유형(energy type) 변경입니까?",
        "text_en": "Is it a control mechanism, operating principle, or energy type change?",
        "yes": "NEW_510K", "no": "B3",
    },
    "B3": {
        "text": "멸균(sterilization), 세척(cleaning), 또는 소독(disinfection) 방법에 변경이 있습니까?",
        "text_en": "Is it a change in sterilization, cleaning, or disinfection?",
        "yes": "B3.1", "no": "B4",
    },
    "B3.1": {
        "text": "\"Category B\" 또는 신규(novel) 멸균법으로 변경되거나, 무균성 보증수준(SAL)이 낮아지거나, "
                "기기 제공 방식(멸균/비멸균, 단일환자·단일사용/다중사용/다중환자)이 변경됩니까?",
        "text_en": "Is it a change to an \"established category B\" or \"novel\" sterilization method, does the "
                   "change lower the sterility assurance level, or is it a change to how the device is provided?",
        "yes": "NEW_510K", "no": "B3.2",
    },
    "B3.2": {
        "text": "변경이 성능 또는 생체적합성(biocompatibility)에 유의미한 영향을 줄 수 있습니까?",
        "text_en": "Could the change significantly affect the performance or biocompatibility of the device?",
        "yes": "NEW_510K", "no": "DOCUMENTATION",
    },
    "B4": {
        "text": "포장(packaging) 또는 유효기간(expiration dating)에 변경이 있습니까?",
        "text_en": "Is there a change in packaging or expiration dating?",
        "yes": "B4.1", "no": "B5",
    },
    "B4.1": {
        "text": "기존에 승인된 510(k)에 기술된 것과 동일한 방법/프로토콜을 사용해 이 변경을 뒷받침합니까?",
        "text_en": "Is the same method or protocol, as described in a previously cleared 510(k), used to support "
                   "the change?",
        "yes": "DOCUMENTATION", "no": "NEW_510K",
    },
    "B5": {
        "text": "그 외 다른 설계 변경(치수, 성능 사양, 무선통신, 구성품/액세서리, 사용자 인터페이스 등)입니까?",
        "text_en": "Is it any other change in design (e.g., dimensions, performance specifications, wireless "
                   "communication, components or accessories, or the patient/user interface)?",
        "yes": "B5.1", "no": "DOCUMENTATION",
    },
    "B5.1": {
        "text": "변경이 기기의 사용(use)에 유의미한 영향을 줍니까?",
        "text_en": "Does the change significantly affect the use of the device?",
        "yes": "NEW_510K", "no": "B5.2",
    },
    "B5.2": {
    ...
    "B5.3": {
        "text": "설계 유효성 검증(design validation)을 위해 임상 데이터(clinical data)가 필요합니까?",
        "text_en": "Are clinical data necessary to evaluate safety or effectiveness for purposes of design "
                   "validation?",
        "yes": "NEW_510K", "no": "B5.4",
    },
    "B5.4": {
        "text": "설계 검증/유효성평가(V&V) 활동에서 예상치 못한 안전성·유효성 문제가 발견됐습니까?",
        "text_en": "Do design verification and/or validation activities produce any unexpected issues of safety "
                   "or effectiveness?",
        "yes": "NEW_510K", "no": "DOCUMENTATION",
    },
    ...
    "C1": {
        "text": "이 기기는 체외진단기기(IVD)입니까?",
        "text_en": "Is the device an in vitro diagnostic device?",
        "yes": "MANUAL_REVIEW_IVD", "no": "C2",
    },
    "C2": {
        "text": "재료 종류(material type), 배합(formulation), 화학적 조성, 또는 가공(processing) 방법에 변경이 있습니까?",
        "text_en": "Is this a change in material type, material formulation, chemical composition, or the "
                   "material's processing?",
        "yes": "C3", "no": "DOCUMENTATION",
    },
    "C3": {
        "text": "변경된 재료가 신체 조직 또는 체액에 직접 또는 간접적으로 접촉합니까?",
        "text_en": "Will the changed material directly or indirectly contact body tissues or fluids?",
        "yes": "C4", "no": "C5",
    },
    "C4": {
    ...
    "C4.1": {
        ...
        "text_en": "Has the manufacturer used the same material in a similar legally marketed device?",
        "yes": "C5", "no": "NEW_510K",
    },
    "C5": {
        "text": "이 변경이 기기의 성능 사양(performance specifications)에 영향을 줄 수 있습니까?",
        "text_en": "Could the change affect the device's performance specifications?",
        "yes": "B5", "no": "DOCUMENTATION",
    },
}
...
def assess_fda(answers: dict, change_info: dict) -> dict:
    ...
    if a.get("MAIN1") is True:
        return {
            ...
            "path": [{
                "id": "MAIN1", "text": FDA_MAIN_ITEMS[0]["text"], "text_en": FDA_MAIN_ITEMS[0]["text_en"],
                "answer": True,
            }],
            "summary": (
    ...
    for item in FDA_MAIN_ITEMS[1:]:
        path.append({
            "id": item["key"], "text": item["text"], "text_en": item["text_en"],
            "answer": a.get(item["key"]),
        })
