...
_NO_SOURCE_NOTE = (
    "※ {ref} 조문/별표 원문은 이 도구에 포함되어 있지 않아 세부 내용을 표시할 수 없습니다. "
    "원문 파일을 제공해 주시면 반영하겠습니다."
)
...
KR_GRAPH = {
    ...
    "M2": {
        ...
        "yes": "M2a", "no": "M3",
        "note": _NO_SOURCE_NOTE.format(ref="「의료기기법」 제7조"),
    },
    "M2a": {
    ...
    "M3": {
        ...
        "note": _NO_SOURCE_NOTE.format(ref="[별표 7]"),
    },
    "M4": {
    ...
    "F1_1a": {
        ...
        "note": _NO_SOURCE_NOTE.format(ref="제19조제6항"),
    },
    "F1_2": {
    ...
    "F1_2a": {
        ...
        "note": _NO_SOURCE_NOTE.format(ref="제19조제1항"),
    },
    "F1_3": {
        "text": "모양 및 구조의 변경입니까?",
        "yes": "F1_3a", "no": "F1_4",
